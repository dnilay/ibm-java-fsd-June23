...
public class App 
{
    public static void main( String[] args )
    {
        try {
			...
			/*
			 * Employee employee1=new Employee(new Random().nextInt(10000), "John", "Doe",
			 * "john@email.com"); Employee employee2=new Employee(new
			 * Random().nextInt(10000), "Marry", "Public", "marry@email.com"); Employee
			 * employee3=new Employee(new Random().nextInt(10000), "Rahul", "Dravid",
			 * "rahul@email.com"); Company ibm=new Company(); ArrayList<Employee> list=new
			 * ArrayList<Employee>(); list.add(employee1); list.add(employee2);
			 * list.add(employee3); ibm.setCompanyId(UUID.randomUUID().toString());
